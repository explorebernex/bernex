 ...
 * Sun Jun 27 2021 23:08:13 GMT+0700 (Indochina Time)
...
eventHTMLElem('click', 'white', true, function(event) {
  setMaterialColor('bODY.001', 'Principled BSDF Color', 0, 0, 0, '#FFF');
});
eventHTMLElem('click', 'black', true, function(event) {
  setMaterialColor('bODY.001', 'Principled BSDF Color', 0, 0, 0, '#252525');
});
eventHTMLElem('click', 'navy', true, function(event) {
  setMaterialColor('bODY.001', 'Principled BSDF Color', 0, 0, 0, '#7A82AD');
});

registerOnClick('Plane.006', false, false, [0,1,2], function() {
  setActiveCamera('Camera.Belakang');
  zoomCamera('Plane.006', 1, function() {});
}, function() {});
registerOnClick('environment', false, false, [0,1,2], function() {
  setActiveCamera('Camera.utama');
}, function() {});

eventHTMLElem('click', 'fold_knife_button', true, function(event) {
  if (getHTMLElemAttribute('value', 'power-status', true) == 'nyala') {
    replaceTexture('Screen.001', 'WhatsApp Image 2021-06-27 at 18.16.47.jpeg.001', 'black.png', function() {});
    setHTMLElemAttribute('value', 'mati', 'power-status', true);
    setHTMLElemStyle('background', 'none !important', 'fold_knife_button', false);
    setHTMLElemStyle('color', 'white', 'fold_knife_button', false);
  } else if (getHTMLElemAttribute('value', 'power-status', true) == 'mati') {
    replaceTexture('Screen.001', 'WhatsApp Image 2021-06-27 at 18.16.47.jpeg.001', 'WhatsApp Image 2021-06-27 at 18.16.47.jpeg', function() {});
    setHTMLElemAttribute('value', 'nyala', 'power-status', true);
    setHTMLElemStyle('background', 'white !important', 'fold_knife_button', false);
    setHTMLElemStyle('color', 'black', 'fold_knife_button', false);
  }
});
